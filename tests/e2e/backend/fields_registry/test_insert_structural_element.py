...
@pytest.mark.asyncio
async def test_insert_structural_element(dummy_structural_element_in: StructuralElementIn, dummy_project: Project):
    st_in_before_function = dummy_structural_element_in.copy()
