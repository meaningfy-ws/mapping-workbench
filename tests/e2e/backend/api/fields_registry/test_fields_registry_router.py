...
@pytest.mark.asyncio
async def test_fields_registry_router(fields_registry_test_client: TestClient,
    ...
    response: Response = fields_registry_test_client.post(route_prefix,
                                                          params={"project_id": dummy_project_id},
                                                          data=dummy_structural_element_in.model_dump_json(
                                                              by_alias=True))
