...
from mapping_workbench.backend.shacl_test_suite.adapters.validator_exporter import SHACLTestDataValidatorExporterHTML
...
def test_shacl_html_exporter(dummy_test_data_file_resource: TestDataFileResource,
    ...
    shacl_html_exporter = SHACLTestDataValidatorExporterHTML()
