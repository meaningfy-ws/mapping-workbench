...
from mapping_workbench.toolchain.sparql_summary.entrypoints.cli.cmd_sparql_summary_generator import \
    main as cli_main
from mapping_workbench.toolchain.sparql_summary.services.sparql_summary_generator import generate_sparql_summary
