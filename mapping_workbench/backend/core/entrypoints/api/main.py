...
from mapping_workbench.backend.mapping_package.entrypoints.api import routes as mapping_package
...
# app_secured_router.include_router(ontology_file_collection.file_resource_router)
app_secured_router.include_router(resource_collection.router)
app_secured_router.include_router(mapping_package.router)
