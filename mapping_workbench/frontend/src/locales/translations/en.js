...
export const en = {
  ...
  [tokens.nav.fields_tree]: 'Tree View',
  [tokens.nav.fields_overview]: 'Overview Fields',
  [tokens.nav.fields_overview_short]: 'Overview',
  [tokens.nav.fields_develop_short]: 'Develop',
